...
<div class="col-sm-8 col-sm-offset-2">
    ...
    <div class="portlet grey-silver box">
        ...
        <div class="portlet-body">
            <div class="row">
                <div class="col-sm-12">
                    <?= $form->field($office_type, 'format_id')->widget(\kartik\select2\Select2::classname(), [
                        'data' => \app\modules\secretariat_v2\models\OfficePrefixFormat::fetchAsDropDownArray(),
                        'options' => [
